...
```
cd existing_repo
git remote add origin https://gitlab.com/sreejith824/techforlife.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/sreejith824/techforlife/-/settings/integrations)
